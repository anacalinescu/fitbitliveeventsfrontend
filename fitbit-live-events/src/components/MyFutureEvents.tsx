...
import MyAttendedFutureEvents from './MyAttendedFutureEvents'
import MyOrganizedFutureEvents from './MyOrganizedFutureEvents'
...
export default function MyFutureEvents() {
            ...
            left: '15%'}}>
                <div className={classes.root}>
                    ...
                    <TabPanel value={value} index={0}>
                        <MyAttendedFutureEvents />
                    </TabPanel>
                    <TabPanel value={value} index={1}>
                        <MyOrganizedFutureEvents />
                    </TabPanel>
                </div>
            </Grid>
        </div>
