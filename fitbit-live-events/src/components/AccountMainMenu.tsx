...
class AccountMainMenu extends React.Component<any, any> {
  static propTypes = {
      ...
      <AppBar className={this.props.classes.appbar}>
        <Container maxWidth='lg'>
          <Toolbar>
            ...
            <DropDownMenu />
            <Link tp="/" className = {this.props.classes.menuButton}>Gallery</Link>
            <Link to="/account" className = {this.props.classes.menuButton}>My Account</Link>
            <Link to="/" onClick={ () => logout() } className = {this.props.classes.menuButton}>Logout</Link>
          </Toolbar>
        </Container>
      </AppBar>
    )
...
export default withStyles(styles)(AccountMainMenu);